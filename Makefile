...
kernel/ideation.o: kernel/ideation.c kernel/ideation.h
	$(CC) $(CFLAGS) -c $< -o $@

os.bin: multiboot_header.o kernel.o shutdown.o reboot.o memory.o timer.o terminal.o debug.o command.o opfs.o minilibc.o boot.o kernel/keyboard.o kernel/io.o kernel/serial.o kernel/net.o kernel/rtl8139.o kernel/ideation.o
